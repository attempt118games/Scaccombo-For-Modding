...
#define COLOUR_1 vec4(0.2, 0.01, 0.01, 1.0)   // warm sunset orange
#define COLOUR_2 vec4(0.90, 0.48, 0.22, 1.0)    // teal / turquoise
#define COLOUR_3 vec4(0.42, 0.01, 0.18, 1.0)   // muted violet-gray
#define CONTRAST 3.0
