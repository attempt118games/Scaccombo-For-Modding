...
#define COLOUR_1 vec4(0.871, 0.267, 0.231, 1.0)   // warm sunset orange
#define COLOUR_2 vec4(0.001, 0.42, 0.706, 1.0)    // teal / turquoise
#define COLOUR_3 vec4(0.086, 0.137, 0.145, 1.0)   // muted violet-gray
#define CONTRAST 3.5
#define SPIN_AMOUNT 0.25
#define PIXEL_FILTER 745
