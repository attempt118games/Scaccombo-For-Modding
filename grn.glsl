...
#define COLOUR_1 vec4(0.01, 0.2, 0.01, 1.0)   // warm sunset orange
#define COLOUR_2 vec4(0.22, 0.9, 0.48, 1.0)    // teal / turquoise
#define COLOUR_3 vec4(0.01, 0.48, 0.18, 1.0)   // muted violet-gray
#define CONTRAST 3.0
